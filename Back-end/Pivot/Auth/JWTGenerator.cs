...
namespace Pivot.Auth
{
    ...
    {
        private readonly string _key = Environment.GetEnvironmentVariable("JWT_KEY") ?? "pivot_secret_key";
        private readonly string _issuer = Environment.GetEnvironmentVariable("JWT_ISSUER") ?? "pivot";
        private readonly string _audience = Environment.GetEnvironmentVariable("JWT_AUDIENCE") ?? "pivot-front.com";
