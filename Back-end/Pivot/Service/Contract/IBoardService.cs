...
namespace Pivot.Service.Contract
{
    public interface IBoardService
    {
        ...
        Task<Result<List<BoardDTO>>> GetAllArchivedByUsername(string username);
        ...
        Task<Result<BoardDTO>> GetResultByNameAndOwnerUsername(string name, string username, string? requestingUsername = null);
        ...
        Task<Result> Unarchive(string name, string ownerUsername, string requestingUsername);
    }
}